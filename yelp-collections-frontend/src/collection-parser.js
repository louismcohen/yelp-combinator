...
const YELP_API_KEY = 'CTpSZtfWaUcJtMZHpnNpq2PaJPs2V-2dbMtrS48ifvMy66V9oK7FnpGmkFQ2jj-5aVBN6OsRB1tjuYPBUKHai7Jn0hI_AlWxEs3ZUvtJStg2Lzfo2w27iaPpXNJKYHYx';
...
window.onload = () => {
    loadCollectionPage().then(() => {
        ...
        console.log(localStorage.getItem(YELP_COLLECTION_ID));
        if (stored_data) {
